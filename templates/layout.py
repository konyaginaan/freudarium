...
<div class="sheet" id="menuSheet" hidden data-pagefind-ignore>
  <div class="sheet-inner">
    ...
    <button class="btn" id="openSettingsBtn">Оформление</button>
  ...
  <div class="sheet-inner">
    ...
    <div class="settings-row">
      ...
      <div class="seg" data-setting="theme">
        <button data-value="system">Система</button>
    ...
    <div class="settings-row">
      ...
      <div class="seg" data-setting="width">
        <button data-value="narrow">Узко</button>
        <button data-value="normal">Средне</button>
        <button data-value="wide">Широко</button>
      </div>
    </div>
